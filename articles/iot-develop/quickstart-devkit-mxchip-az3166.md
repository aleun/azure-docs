...
1. In your file manager, find the MXCHIP DevKit device connected to your computer. The device appears as a drive on your system with the drive label **AZ3166**.
...
For debugging the application, see [Using Visual Studio Code with the MXChip AZ3166 IoT DevKit](https://github.com/azure-rtos/getting-started/blob/master/MXChip/AZ3166/vscode.md).
